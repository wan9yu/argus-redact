...
**Detection accuracy** (measured at **v0.7.16** — Layer-1 detection has changed since; see [benchmark-report](docs/benchmark-report.md) for currency)
