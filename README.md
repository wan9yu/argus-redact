...
| Dimension | Current (v0.5.5) | Next milestone |
|-----------|:----------------:|:---:|
| **Protected** | ~47 PII types, L1-L4. PII leak 0% across GPT-4o / Claude / Gemini. Cross-layer hints. MCP token-only key handling | Adversarial testing |
