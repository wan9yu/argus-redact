...
class TestReportSensitivityIsEffectiveLang:
    ...
    def test_en_report_should_use_en_typedef_sensitivity_not_zh(self, type_name, text, names):
    ...
    def test_zh_report_should_use_zh_typedef_sensitivity(self, type_name, text, names):
    ...
    def test_zh_only_type_under_en_should_fall_back_to_first_registered(self):
    ...
    def test_intl_only_type_under_en_should_fall_back_to_first_registered(self):
    ...
    def test_register_pii_type_absent_from_ron_should_still_score(self):
...
class TestReportRiskDirectional:
    def test_en_person_plus_phone_should_not_be_critical(self):
    ...
    def test_en_date_of_birth_should_be_high_not_zh_deflated_medium(self):
...
class TestEmptyLangGuard:
    def test_empty_lang_list_report_should_raise_valueerror_not_indexerror(self):
    ...
    def test_empty_lang_list_default_should_raise_valueerror(self):
        with pytest.raises(ValueError, match="No language specified"):
            redact("张伟手机13812345678", lang=[], mode="fast")

    def test_empty_lang_pre_detected_report_should_raise_valueerror(self):
    ...
    def test_empty_lang_should_not_fail_open(self):
