...
FROZEN_SIGNATURES = {
    "redact_json": "(data: 'dict | list', *, mode: 'str' = 'fast', lang: 'str | list[str]' = 'zh', salt: 'int | bytes | None' = None, config: 'dict | None' = None, key: 'dict | None' = None, paths: 'list[str | list[str]] | None' = None, with_types: 'bool' = False, with_aliases: 'bool' = False) -> 'tuple[dict | list, dict] | tuple[dict | list, dict, dict] | tuple[dict | list, dict, dict, dict]'",  # noqa: E501
