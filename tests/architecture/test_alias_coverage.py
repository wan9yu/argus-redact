...
def test_every_zh_reserved_name_should_have_an_alias():
...
def test_every_en_reserved_name_should_have_an_alias():
...
def test_every_zh_reserved_address_should_have_an_alias():
...
def test_every_en_reserved_address_should_have_an_alias():
