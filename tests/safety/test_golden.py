...
class TestGoldenSeedDeterminism:
    ...
    def test_golden_zh_phone(self):
        ...
        redacted2, key2 = redact("电话13812345678", salt=42, mode="fast")
    ...
    def test_golden_roundtrip_preserves_original(self):
        ...
        cases = [
            (
                "张三电话13812345678",
                {"salt": 42, "mode": "fast", "names": ["张三"]},
                ["13812345678", "张三"],
            ),
            ("身份证110101199003074610", {"salt": 99, "mode": "fast"}, ["110101199003074610"]),
            (
                "I was diagnosed with diabetes",
                {"salt": 42, "mode": "fast", "lang": "en"},
                ["diabetes"],
            ),
        ]
...
class TestUnicodeBoundary:
    ...
    def test_should_handle_emoji_without_false_match(self):
        ...
        redacted, key = redact("心情很好😀👍🎉", salt=42, mode="fast")
    ...
    def test_should_handle_number_emoji_without_false_match(self):
        ...
        redacted, key = redact("步骤1️⃣2️⃣3️⃣完成", salt=42, mode="fast")
