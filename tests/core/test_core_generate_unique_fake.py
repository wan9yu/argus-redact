...
def test_generate_unique_fake_builtin_reroll():
    ...
    fake, aliases = _core.generate_unique_fake("fake_phone_reserved", "13800138000", "phone", salt, set())
    ...
    fake2, _ = _core.generate_unique_fake("fake_phone_reserved", "13800138000", "phone", salt, {fake})
