...
def test_generate_unique_fake_should_reroll_when_first_fake_is_already_reserved():
...
def test_generate_unique_fake_should_raise_value_error_when_name_is_unknown():
    import pytest
