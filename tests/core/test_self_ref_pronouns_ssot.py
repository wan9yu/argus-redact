...
def test_core_self_ref_pronouns_matches_frozen_set():
    # Captured from: python -c "from argus_redact.pure.grammar import SELF_REF_PRONOUNS; print(sorted(SELF_REF_PRONOUNS))"
    # ['I', 'me', 'mine', 'my', 'myself', 'our', 'ours', 'ourselves', 'us', 'we']
    EXPECTED = frozenset({"I", "me", "mine", "my", "myself", "our", "ours", "ourselves", "us", "we"})
