...
def test_csv_should_preserve_leading_whitespace_of_first_cell():
...
def test_csv_should_preserve_interior_whitespace_cells():
    text = "x, ,y\r\np,q,r"
    redacted, _key = redact_csv(text, has_header=False, mode="fast", lang="zh", salt=42)
    import csv
    import io
...
def test_csv_should_not_leave_trailing_blank_line_from_writer():
