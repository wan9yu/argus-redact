...
LANG_CORPUS = [
    ...
    "中文 with english", "日本語 and 中文", "한국어 中文",
    "ＡＢＣ", "123 456",
    "こんにちは", "カタカナ", "こんにちは 中文",  # hiragana/katakana → exercise the ja path
]
...
def test_normalize_and_detect_parity():
    ...
    if not FIXTURE.exists():
        ...
        FIXTURE.write_text(json.dumps(current, ensure_ascii=False, indent=2, sort_keys=True), encoding="utf-8")
        raise AssertionError("Wrote v0.7.1 normalize snapshot — re-run to compare. COMMIT the fixture.")
